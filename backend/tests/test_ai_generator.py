...
class TestAIGenerator:
    ...
    def test_single_tool_call_backward_compatibility(
        self, ai_generator, mock_tool_manager, sample_tools
    ):
        ...
        mock_tool_manager.execute_tool.return_value = (
            "Found: Python fundamentals lesson"
        )
    ...
    def test_sequential_two_tool_calls(
        ...
        final_response.content = [
            Mock(text="Based on the outline and search results...")
        ]
    ...
    def test_early_termination_no_tool_use(
        ...
        # Execute
        result = ai_generator.generate_response(
            query="What is Python?", tools=sample_tools, tool_manager=mock_tool_manager
        )
    ...
    def test_api_error_handling(self, ai_generator, mock_tool_manager, sample_tools):
        ...
        # Simulate API error
        ai_generator.client.messages.create.side_effect = Exception(
            "API connection failed"
        )

        # Execute
        result = ai_generator.generate_response(
            query="Test query", tools=sample_tools, tool_manager=mock_tool_manager
        )
    ...
    def test_context_preservation_between_rounds(
        self, ai_generator, mock_tool_manager, sample_tools
    ):
    ...
    def test_no_tools_available(self, ai_generator):
        ...
        result = ai_generator.generate_response(query="Answer this question")
